...
Por isso criei este repositório, onde testei labels que possivelmente funcionem, embora sejam originalmente de outros carros/ecus.
...
- **Veículo Testado:** VW Novo Gol G6 2014 1.0 CPBA (Motor EA111 TEC 1.0 4 Cilindros)
...
1. Baixe este repositório como um .zip
...
2. Copie a label de referência
    ...
    - Abra a pasta `Labels` na pasta recém extraída.
...
3. Copie a label de redirecionamento 

	- Abra a pasta `Labels\User` na pasta recém extraída.
